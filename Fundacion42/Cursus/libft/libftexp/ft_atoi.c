...
/*   Updated: 2023/02/26 18:55:43 by dmena-ro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
1. La función ft_atoi() recibe un parámetro st de tipo const char* y
 devuelve un valor de tipo size_t.
 
2. Declara tres variables i, n y neg de tipo size_t y les asigna los 
valores 0, 0 y 0 respectivamente.

3. Recorre la cadena st desde el principio hasta encontrar un carácter
 que no sea un espacio en blanco o un salto de línea, y actualiza el 
 valor de i con cada iteración.
 
4. Comprueba si el carácter actual es un signo positivo o negativo,
 y si lo es, incrementa el valor de neg si es negativo y avanza al
  siguiente carácter.
  
5. Recorre la cadena st desde el carácter actual hasta encontrar un
 carácter que no sea un dígito numérico, y actualiza los valores de
  n e i con cada iteración. Para calcular n, multiplica el valor 
  anterior por 10 y le suma el valor del dígito actual restándole 
  el valor ASCII del carácter ‘0’.
  
6. Comprueba si el valor de neg es impar, y si lo es, multiplica n 
por -1 para cambiar su signo.
